            ...
            <div class="container">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    <div class="col">
                        ...
                        <img src="<?php echo e(('img/malinkundang.jpg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                        <img src="<?php echo e(('img/timunmas.jpg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                                <rect width="100%" height="100%" fill="#55595c" />
                            </svg>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                        <img src="<?php echo e(('img/tangkuban.jpg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                                <rect width="100%" height="100%" fill="#55595c" />
                            </svg>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                        <img src="<?php echo e(('img/jakatarub.jpg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                                <rect width="100%" height="100%" fill="#55595c" />
                            </svg>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                        <img src="<?php echo e(('img/keongmas.jpg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                                <rect width="100%" height="100%" fill="#55595c" />
                            </svg>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                        <img src="<?php echo e(('img/purbasari.png')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                                <rect width="100%" height="100%" fill="#55595c" />
                            </svg>
                            <div class="card-body">
...
</html><?php /**PATH C:\laragon\www\project-tania\resources\views/characteristic/legenda.blade.php ENDPATH**/ ?>