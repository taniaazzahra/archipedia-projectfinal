            ...
            <div class="container">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    <div class="col">
                        ...
                        <img src="<?php echo e(('img/harimausum.jpg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                        <img src="<?php echo e(('img/orangutan.jpg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                                <rect width="100%" height="100%" fill="#55595c" />
                            </svg>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                        <img src="<?php echo e(('img/jalakbali.jpg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                                <rect width="100%" height="100%" fill="#55595c" />
                            </svg>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                        <img src="<?php echo e(('img/komodo.jpg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                                <rect width="100%" height="100%" fill="#55595c" />
                            </svg>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                        <img src="<?php echo e(('img/cendrawasih.jpg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                                <rect width="100%" height="100%" fill="#55595c" />
                            </svg>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                        <img src="<?php echo e(('img/gajah.jpg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                                <rect width="100%" height="100%" fill="#55595c" />
                            </svg>
                            <div class="card-body">
...
</html><?php /**PATH C:\laragon\www\project-tania\resources\views/characteristic/fauna.blade.php ENDPATH**/ ?>