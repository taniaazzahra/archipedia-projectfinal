            ...
            <div class="container">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    <div class="col">
                        ...
                        <img src="<?php echo e(('img/pulaukomodo.jpg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                        <img src="<?php echo e(('img/toraja.jpg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                                <rect width="100%" height="100%" fill="#55595c" />
                            </svg>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                        <img src="<?php echo e(('img/wakatobi.jpeg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                                <rect width="100%" height="100%" fill="#55595c" />
                            </svg>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                        <img src="<?php echo e(('img/bromo.jpeg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                                <rect width="100%" height="100%" fill="#55595c" />
                            </svg>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                        <img src="<?php echo e(('img/jayawijaya.jpg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                                <rect width="100%" height="100%" fill="#55595c" />
                            </svg>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                        <img src="<?php echo e(('img/prambanan.jpg')); ?>" svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                                <rect width="100%" height="100%" fill="#55595c" />
                            </svg>
                            <div class="card-body">
...
</html><?php /**PATH C:\laragon\www\project-tania\resources\views/characteristic/wisata.blade.php ENDPATH**/ ?>