...
<html lang="en">
  ...
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <img src="<?php echo e(('img/borobudur.jpg')); ?>" width="100%" height="200%">
      ...
      <img src="<?php echo e(('img/harimau.jpg')); ?>" width="100%" height="150%">
        <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#777"/></svg>
      ...
      <div class="carousel-item">
      <img src="<?php echo e(('img/makanan.jpg')); ?>" width="100%" height="150%">
        <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#777"/></svg>
  ...
  <div class="container marketing">
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
      <img src="<?php echo e(('img/raja.jpg')); ?>" width="450px" height="450px">
    ...
    <div class="row featurette">
      ...
      <img src="<?php echo e(('img/kelor.jpg')); ?>" width="450px" height="450px">
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
      <img src="<?php echo e(('img/toba.jpg')); ?>" width="450px" height="450px">
...
<?php /**PATH C:\laragon\www\project-tania\resources\views/home.blade.php ENDPATH**/ ?>